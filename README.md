...
4. **Analysis layer** - built Key Indicators, Business Correlations, Business Metrics, and Performance Indices directly off the cleaned dataset in Excel.
5. **Dashboarding** - modeled and visualized in Power BI Desktop, including a decomposition tree, geographic mapping, and an interactive NLP Q&A feature.
